    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <motion.p
            className="text-2xl text-gray-900 mb-8 leading-relaxed font-bold drop-shadow-lg bg-white/80 backdrop-blur-sm rounded-xl px-6 py-4 border border-blue-100"
            initial={shouldReduceMotion ? undefined : "hidden"}
            animate={shouldReduceMotion ? undefined : "visible"}
            variants={fadeUp}
